   ...
   function neirong1(small){
    ...
    let tit2=document.querySelectorAll(".shanGou .title .tit2");
   	...
   	function time8(){
	   	let ast=[];
	   	let now=new Date();
	   	let future=new Date(2018,6,27,22,00);
   	...
   	function time9(){
	   	let shijian=document.querySelectorAll(".shanGou .shijian");
	   	let ast=time8();
	   	shijian.forEach(function(val,ind){
	   		val.innerText=ast[ind];
	   		if(ast[ind]<10){
	   			val.innerText="0"+ast[ind];
	   		}
	   	})
   	}
   	setInterval(time9,1000);
    //固定定位
    let boxa=document.querySelectorAll(".fixed .son .box");
    let boxa1=document.querySelector(".fixed .son1 .box");
    let sona=document.querySelector(".fixed .son1");
    let imga=document.querySelectorAll(".fixed .son .box img");
    let imga1=document.querySelectorAll(".fixed .son1 .box img");
    let pa=document.querySelectorAll(".fixed .son .box p");
    let pa1=document.querySelector(".fixed .son1 .box p");
    let fixed=document.querySelector(".fixed");
    let xiabiao=document.querySelector(".xiaBiao");
    console.log(xiabiao);
    boxa[0].onmouseenter=function(){
        imga[1].style.display="block";
        pa[0].style.color="#ff6700"
    }
    boxa[0].onmouseleave=function(){
        imga[1].style.display="none";
        pa[0].style.color="#757575"
    }
    boxa[1].onmouseenter=function(){
        imga[3].style.display="block";
        pa[1].style.color="#ff6700"
    }
    boxa[1].onmouseleave=function(){
        imga[3].style.display="none";
        pa[1].style.color="#757575"
    }
    boxa[2].onmouseenter=function(){
        imga[5].style.display="block";
        pa[2].style.color="#ff6700"
    }
    boxa[2].onmouseleave=function(){
        imga[5].style.display="none";
        pa[2].style.color="#757575"
    }
    boxa1.onmouseenter=function(){
        imga1[1].style.display="block";
        pa1.style.color="#ff6700"
    }
    boxa1.onmouseleave=function(){
        imga1[1].style.display="none";
        pa1.style.color="#757575"
    }
    document.onscroll=function(){
      let b=document.body.scrollTop||document.documentElement.scrollTop;
      let a=xiabiao.offsetTop-window.innerHeight;
      console.log(a,b);
      if(b==a+57){
